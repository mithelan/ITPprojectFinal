			...
			<div class="row">
				<div class="col-md-6 py-5 pr-md-5">
					...
					<form action="AddServlet2" method="post"
						...
						<div class="d-md-flex">
							<div class="form-group">
								<input type="text" name="pid" cols="30" rows="2"
						...
						<div class="block-23 mb-3">
							<ul>
								<li><span class="icon icon-map-marker"></span><span
									class="text">Jaffna Town </span></li>
								<li><a href="#"><span class="icon icon-phone"></span><span
										class="text">0712534869</span></a></li>
								<li><a href="#"><span class="icon icon-envelope"></span><span
										class="text">donuts.inc@gmail.com</span></a></li>
							</ul>
						</div>
				...
				<div class="col-md">
					...
					<div class="ftco-footer-widget mb-5 ml-md-4">
						...
						<ul class="list-unstyled">
							...
							<li><a href="#"><span
									class="ion-ios-arrow-round-forward mr-2"></span>Ambulance</a></li>
							<li><a href="#"><span
									class="ion-ios-arrow-round-forward mr-2"></span>Become A
									Supplier</a></li>
						</ul>
					</div>
				</div>
				...
				<div class="col-md">
					<div class="ftco-footer-widget mb-5">
						...
						<h3 class="open-hours pl-4">
							<span class="ion-ios-time mr-3"></span>We are open Monday-Friday
							9am-1pm
						</h3>
					</div>
					<div class="ftco-footer-widget mb-5">
