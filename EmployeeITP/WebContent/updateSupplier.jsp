...
String sql ="select * from addsupp where supid="+supid;
...
<form method="post" action="update_process.jsp">
			...
			<tr>
				<lable id="a">SupplierID:</lable>
				<td><input type="text" name="supid"
					value="<%=resultSet.getString("supid") %>" /></td><br>
			</tr>
			<tr>
				<lable id="a">Supplier:</lable>
				<td><input type="text" name="supplier"
					value="<%=resultSet.getString("supplier") %>" /></td><br>
			</tr>
			<tr>
				<lable id="a">Product:</lable>
				<td><input type="text" name="product"
					value="<%=resultSet.getString("product") %>" /></td><br>
			</tr>
			<tr>
				<lable id="a">UnitPrice:</lable>
				<td><input type="text" name="unitprice"
					value="<%=resultSet.getString("unitprice") %>" /></td><br>
			</tr>
		
			<tr>
				<td colspan="2"><input type="hidden" name="supid"
					value="<%=resultSet.getString("supid")%>" /> 
	<button type="submit" value="Submit" id="button" onClick="">UPDATE</button></td>
			</tr>
