...
<ul>
 ...
 <div class="bod">
    ...
    <button class="button"><span>Search</span></button>
	 ...
	 <div class="Arrange">
  <h4>YOUR RESULTS ARE BELOW!</h4><br>
...
String sql ="SELECT a.date,p.nic,p.phone FROM appoint a,payment p where a.AppId=p.payid and date Between '"+request.getParameter("startdate")+"' and '"+request.getParameter("endate")+"' ";
