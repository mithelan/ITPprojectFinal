...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="patient_reg.jsp" class="w3-bar-item w3-button w3-padding-large w3-hide-small">Register</a>
     <a href="#tour" class="w3-bar-item w3-button w3-padding-large w3-hide-small">Feedback</a>
      <a href="#tour" class="w3-bar-item w3-button w3-padding-large w3-hide-small">testmonials</a>
      ...
      <div class="w3-row-padding w3-padding-32" style="margin:0 -16px">
        <div class="w3-third w3-margin-bottom">
          ...
          <div class="w3-container w3-white">
            ...
            <p></p>
            <button class="w3-button w3-black w3-margin-bottom" onclick="window.location.href = 'Register_Akshi.jsp';">Become a supplier</button>
          </div>
        </div>
        ...
        <div class="w3-third w3-margin-bottom">
          ...
          <div class="w3-container w3-white">
            ...
            <button class="w3-button w3-black w3-margin-bottom" onclick="window.location.href = 'Appoint.jsp';">Book appointment</button>
          </div>
        </div>
        <div class="w3-third w3-margin-bottom">
          ...
          <div class="w3-container w3-white">
            ...
            <button class="w3-button w3-black w3-margin-bottom" onclick="window.location.href = 'Appoint.jsp';"> Request ambulance</button>
          </div>
        </div>
      </div>
    </div>
...
<div  style="border-style:solid;width:950px;margin-left:20px; margin-top:60px"> 
